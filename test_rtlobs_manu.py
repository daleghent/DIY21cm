...
centerFrequency = 1.420e9 # [Hz] center frequency
...
centerFrequency = 1.420e9 # [Hz] center frequency
throwFrequency = 1.420e9 + 1.e6 # [Hz] alternate frequency. The freq diff has to be less than achieved bandwidth
# Too bad, I would like a shift of 3.e6 Hz for my 21cm line...
switchFrequency = 1.   # [Hz] frequency at which we switch between fiducial and shifted freqs
...
# Show the figure containing the plotted spectrum
fig, ax = post.plot_spectrum(f, p, savefig='./figures/spectrum_fswitch_'+str(integrationTime)+'sec.pdf')
#fig.show()
fig.clf()
